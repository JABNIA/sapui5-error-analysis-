  ...
  function (
    ...
    return BaseController.extend("project1.controller.Worklist", {
          ...
          for (i = 0; i < aSelectedProducts.length; i++) {
            ...
            this.getModel().remove(sPath, {
              success: () => {
                ...
                oViewModel.setProperty("/actionEnabled", false);
      ...
      onUpdateStockObjects: function () {
        ...
        if (aSelectedProducts.length > 0) {
          for (i = 0; i < aSelectedProducts.length; i++) {
            ...
            oProductObject = this.getModel().getProperty(sPath);
            oProductObject.UnitsInStock += 5;
      ...
      onSelectionChange() {
        ...
        const oViewModel = this.getModel("worklistView");
        if (aSelectedProducts > 0) {
          oViewModel.setProperty("/actionEnabled", true);
        } else {
          oViewModel.setProperty("/actionEnabled", false);
        }
      },
